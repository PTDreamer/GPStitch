...
AVAILABLE_METRICS = [
    ...
    SelectOption(value="accl", label="Acceleration (sensor)"),
    SelectOption(value="accl.dyn", label="Acceleration (no gravity)"),
    SelectOption(value="accl.dyn.x", label="Acceleration X (no gravity)"),
    SelectOption(value="accl.dyn.y", label="Acceleration Y (no gravity)"),
    SelectOption(value="accl.dyn.z", label="Acceleration Z (no gravity)"),
